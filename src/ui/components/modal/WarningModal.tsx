...
export const WarningModal: FC = memo(() => {
  ...
  return createPortal(
    <div className="fixed top-0 left-0 w-screen h-screen flex justify-center items-center bg-[#00000080] z-100">
      <div className="relative flex flex-col rounded-[10px] items-center justify-between gap-12 py-12 px-32 bg-[var(--white)] w-160.75 h-146 z-101">
        {/* Close X button */}
